...
<Caption>Detecting a stud and nailing the plywood sheet down.</Caption>
...
<Caption>Preparing to put in the next row of nails. Turn, forward, turn, align, forward.</Caption>
...
<Caption>Aligning routine states. The black dots are ultrasonic sensors. The line is the edge of the roof.</Caption>
